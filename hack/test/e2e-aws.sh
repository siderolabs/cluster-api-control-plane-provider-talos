...
TALOS_VERSION="${TALOS_DEFAULT:-v1.10.0-beta.0}" # NOTE: this is Talos version for the test environment, not Talos version for CAPI templates (see capi-utils)
K8S_VERSION="${K8S_VERSION:-v1.31.7}"
export WORKLOAD_KUBERNETES_VERSION="${WORKLOAD_KUBERNETES_VERSION:-${K8S_VERSION}}"
export UPGRADE_K8S_VERSION="${UPGRADE_K8S_VERSION:-v1.32.3}"
KUBECONFIG=
