...
TALOS_VERSION="${TALOS_DEFAULT:-v1.5.0}" # NOTE: this is Talos version for the test environment, not Talos version for CAPI templates (see capi-utils)
K8S_VERSION="${K8S_VERSION:-v1.27.0}"
export WORKLOAD_KUBERNETES_VERSION="${WORKLOAD_KUBERNETES_VERSION:-${K8S_VERSION}}"
export UPGRADE_K8S_VERSION="${UPGRADE_K8S_VERSION:-v1.27.1}"
KUBECONFIG=
