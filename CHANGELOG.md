...
* [`0cefd49`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/0cefd49d46d2b68b0f649e6bd1caf8b52bc9776c) feat: updare to Talos 1.10.0 final
* [`a1c862e`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/a1c862ed743b65a46b06a62084dfa9d462574f76) feat: update CACPPT to Talos 1.10
* [`7fb93f5`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/7fb93f51ed5b1b6ca5a9a5473e9647a6b382f2d3) feat: use kres for github actions
</p>
</details>
...
Previous release can be found at [v0.5.8](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/releases/tag/v0.5.8)
...
* [`bb404b6`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/bb404b67c0b697dcc26da5dca0cc24106931513b) feat: update for Talos 1.5.0
* [`210c95c`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/210c95c958fa56a7e210220e76d5eafc083084a6) docs: fix typo in README
* [`24262e7`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/24262e75fc37c4e8029c41a74623455c8cdd44f6) fix: introduce 5 second timeout for each Talos client call
* [`b0a8ce2`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/b0a8ce2aad21a401797a1dee3c0354210a775456) fix: log actual error message in the reconcile error
</p>
</details>
...
* [`8c0eba4`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/8c0eba4c6129a80ae4f05ca11bb07bf79fc5c042) release(v0.5.0-alpha.2): prepare release
...
* [`db4f973`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/db4f973c8a3824427659935347a5f54bc10302af) release(v0.5.0-alpha.1): prepare release
* [`ab24901`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/ab24901f4e2d444a50a67032ccb0f781b1fdf42e) release(v0.5.0-alpha.0): prepare release
